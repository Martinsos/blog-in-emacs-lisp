...
Here I describe how I did it and I also share a template repo[fn:1] with full working code you can use to create your own blog.
...
For full working code, check out my *github template repo*[fn:1] that I derived from my personal blog implementation described in this blog.
