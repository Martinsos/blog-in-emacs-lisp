...
#+DATE: 2017-12-09
#+DESCRIPTION: How to set up your Emacs to have the features you would expect from modern C++ IDE.
#+FILETAGS: :development:emacs:

#+CAPTION: Emacs + C++
[[file:emacs-cpp-ide/emacs-cpp.webp]]
